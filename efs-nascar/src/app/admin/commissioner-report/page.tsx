        ...
        <div ref={reportRef} className="max-w-[780px] mx-auto bg-[#141414] border border-[#2a2a2a] rounded-xl overflow-hidden">
          ...
          <div>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  <th className="text-[10px] uppercase tracking-[0.5px] text-gray-500 px-2 py-2 text-center border-b border-[#2a2a2a] w-8">Rk</th>
                  ...
                  <th className="text-[10px] uppercase tracking-[0.5px] text-gray-500 px-1 py-2 text-center border-b border-[#2a2a2a] w-7">W</th>
                  <th className="text-[10px] uppercase tracking-[0.5px] text-gray-500 px-1 py-2 text-center border-b border-[#2a2a2a] w-7">Stg</th>
                  <th className="text-[10px] uppercase tracking-[0.5px] text-gray-500 px-1 py-2 text-center border-b border-[#2a2a2a] w-7">LL</th>
                  <th className="text-[10px] uppercase tracking-[0.5px] text-gray-500 px-1 py-2 text-center border-b border-[#2a2a2a] w-7">T10</th>
                ...
                {report.standings.map((s, idx) => (
                  <>
                    ...
                    <tr key={s.teamId} className={`hover:bg-[#1a1a1a] ${idx === report!.luckyDogPosition - 1 ? 'bg-[#1a1608]' : ''}`}>
                      ...
                      <td className="px-1 py-2 text-center text-sm text-gray-300">{s.stageWins}</td>
                      <td className="px-1 py-2 text-center text-sm text-gray-300">{s.lapsLedBonuses}</td>
                      <td className="px-1 py-2 text-center text-sm text-gray-300">{s.top10Bonuses}</td>
